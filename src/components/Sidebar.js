  ...
  <div className="sidebar">
    <div className="section links-page">
      ...
      <p className="links-title">
        Hi! I'm Pawel,<span className="colored"> I share</span> what I learn
        from my <span className="colored">everyday work</span> as a{' '}
      ...
      <div className="links-articles-container">
        ...
        >
          <img
            ...
            alt="celebrate app logo"
            src={celebrateAppLogo}
          />
